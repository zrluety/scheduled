...
def test_wells_fargo_session():
    ...
    expected = pd.read_excel(os.path.join(TEST_DATA_DIR, "201601 1205-EatonsNeck.xlsx"),
                             header=None, names=['date', 'security name', 'transaction type', 'shares', 'transaction price', 'amount'])
